...
Route::post('/notifications/mark-as-read', [NotificationController::class, 'markAllAsRead'])->name('notifications.mark-as-read')->middleware('auth:tuteur');
...
Route::post('/dashboard/custom-chart-delete', [\App\Http\Controllers\DashboardController::class, 'customChartDelete'])->name('dashboard.customChartDelete');
...
Route::post('/send-announcement', [AnnouncementController::class, 'store'])->name('announcements.store');
...
Route::get('/email/teacher-login', function () {
    return view('emails.teacher-login');
